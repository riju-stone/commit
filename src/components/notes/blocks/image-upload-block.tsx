...
const ImageUploadDragArea: React.FC<ImageUploadDragAreaProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center gap-3 p-6 w-full h-full transition-colors ${isDragActive ? "border-white/50" : ""} ${isDragOver ? "border-white/70 bg-white/5" : ""}`}
...
const ImageUploadPreview: React.FC<ImageUploadPreviewProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-md border border-white/20 bg-transparent">
...
const DropZoneContent: React.FC<{ maxSize: number; limit: number }> = ({
  ...
  <>
    <div className="flex items-center justify-center rounded-full border border-dashed border-white/30 p-4">
      <UploadCloud className="size-6 text-white/70" />
    </div>

    <div className="flex flex-col items-center gap-1 text-center">
      <span className="text-sm text-white">
        <em className="not-italic font-medium">Click to upload</em> or drag and drop
      </span>
      <span className="text-xs text-white/60">
...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  return (
    <NodeViewWrapper
      className="my-4 cursor-pointer rounded-lg border border-dashed border-white/20 bg-transparent transition-colors hover:border-white/40 hover:bg-white/5 focus:outline-none focus:border-white/50"
      tabIndex={0}
      onClick={handleClick}
    >
      {!hasFiles && (
        ...
        <div className="flex flex-col gap-2 p-4">
          {fileItems.length > 1 && (
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-white">Uploading {fileItems.length} files</span>
              <Button
                type="button"
                data-style="ghost"
                onClick={(e) => {
